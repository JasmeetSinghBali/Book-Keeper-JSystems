        ...
        <section className={`${styles.yPaddings} sm:pl-3 pl-6`}>
            ...
            >
                <div className="flex justify-center items-center flex-col relative  z-10">
                    ...
                    >
                        <div className="md:w-[80px] sm:w-[45px] w-[20px] md:h-[88px] sm:h-[45px] h-[38px] md:border-[12px] border-[9px] rotate-45 hover:skew-y-12 border-white-400 sm:mx-4 mx-[6px] space-x-0.5 " />
